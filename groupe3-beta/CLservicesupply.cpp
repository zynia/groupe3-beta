...
System::String^ NS_Comp_Svc_Supply::CLservicesupply::Update() {
	return "EXEC SP_UA "+this->oMapArtSup->getidarticle().ToString()+", @color_article ="+this->oMapArtSup->getColorarticle()+", @type_article ="+this->oMapArtSup->getTypearticle()+", @margin_article ="+this->oMapArtSup->getMarginarticle()+", @replenishment_threshold ="+this->oMapArtSup->getReplenishmentthreshold().ToString()+", @HT ="+this->oMapArtSup->getHT()+", @name_article ="+this->oMapArtSup->getNamearticle()+", @discount ="+this->oMapArtSup->getDiscount()+", @TVA ="+this->oMapArtSup->getTVA()+", @inventory_shrinkage ="+this->oMapArtSup->getInventoryshrinkage()+", @nb_stock ="+this->oMapArtSup->getNbstock().ToString();
}