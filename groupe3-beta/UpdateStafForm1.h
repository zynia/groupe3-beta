...
namespace Gstorg {
	...
	/// <summary>
	/// Summary for UpdateStaffForm
	/// </summary>
	public ref class UpdateStaffForm : public System::Windows::Forms::Form
	{
	public:
		UpdateStaffForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->FirstNameBox->Location = System::Drawing::Point(486, 121);
			...
			this->LastNameBox->Font = (gcnew System::Drawing::Font(L"Arial Narrow", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->LastNameBox->Location = System::Drawing::Point(486, 158);
			...
			this->BirthdateBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->BirthdateBox->Location = System::Drawing::Point(486, 195);
			...
			this->HiringDateBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->HiringDateBox->Location = System::Drawing::Point(486, 232);
			...
			this->SupervisorBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->SupervisorBox->Location = System::Drawing::Point(486, 267);
			...
			this->StreetNameBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->StreetNameBox->Location = System::Drawing::Point(179, 84);
			...
			this->StreetNumberBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->StreetNumberBox->Location = System::Drawing::Point(179, 116);
			...
			this->ResidencyNameBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->ResidencyNameBox->Location = System::Drawing::Point(179, 148);
			...
			this->FloorNumberBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->FloorNumberBox->Location = System::Drawing::Point(179, 212);
			...
			this->ComplementBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->ComplementBox->Location = System::Drawing::Point(179, 246);
			...
			this->CityNameBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->CityNameBox->Location = System::Drawing::Point(179, 276);
			...
			this->PostCodeBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->PostCodeBox->Location = System::Drawing::Point(179, 308);
			this->PostCodeBox->Name = L"PostCodeBox";
			this->PostCodeBox->Size = System::Drawing::Size(130, 22);
			this->PostCodeBox->TabIndex = 11;
			this->PostCodeBox->TextChanged += gcnew System::EventHandler(this, &UpdateStaffForm::DisplayID_TextChanged);
			// 
			// DisplayAdressBox
			// 
			...
			this->DisplayAdressBox->Location = System::Drawing::Point(134, 40);
			...
			this->DisplayPersonnalinfoBox->Location = System::Drawing::Point(406, 40);
			...
			this->DisplayFirstName->Location = System::Drawing::Point(386, 121);
			...
			this->DisplayLastname->Location = System::Drawing::Point(386, 158);
			...
			this->DisplayBirthDate->Location = System::Drawing::Point(386, 195);
			...
			this->DisplayHiringDate->Location = System::Drawing::Point(386, 232);
			...
			this->DisplaySupervisorId->Location = System::Drawing::Point(386, 267);
			...
			this->DisplayStreetName->Location = System::Drawing::Point(59, 84);
			...
			this->DisplayStreetNumber->Location = System::Drawing::Point(59, 116);
			...
			this->DisplayResidencyname->Location = System::Drawing::Point(59, 148);
			...
			this->DisplayBuildingName->Location = System::Drawing::Point(59, 180);
			...
			this->DisplayFloorNumber->Location = System::Drawing::Point(59, 212);
			...
			this->DisplayComplement->Location = System::Drawing::Point(59, 246);
			...
			this->DisplayCityName->Location = System::Drawing::Point(59, 276);
			...
			this->BuildingNameBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->BuildingNameBox->Location = System::Drawing::Point(179, 180);
			...
			this->DisplayPostcode->Location = System::Drawing::Point(59, 308);
			...
			this->DisplayID->Location = System::Drawing::Point(386, 84);
			this->DisplayID->Name = L"DisplayID";
			this->DisplayID->ReadOnly = true;
			this->DisplayID->Size = System::Drawing::Size(90, 22);
			this->DisplayID->TabIndex = 32;
			this->DisplayID->Text = L"Staff ID:";
			// 
			// IDBox
			// 
			this->IDBox->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->IDBox->Location = System::Drawing::Point(486, 84);
			...
			// SendButton
			// 
			this->SendButton->Location = System::Drawing::Point(445, 310);
			...
			this->Name = L"UpdateStaffForm";
			this->Text = L"UpdateStaffForm";
			this->Load += gcnew System::EventHandler(this, &UpdateStaffForm::UpdateStaffForm_Load);
